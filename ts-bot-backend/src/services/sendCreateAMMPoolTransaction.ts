...
export const sendCreateAMMPoolTransaction = async (tx: Transaction, signers: Keypair[], userId: number) => {
    ...
    try {
        ...
        sig = await sendAndConfirmTransaction(devnetConnection, tx, [signer, ...signers]);
